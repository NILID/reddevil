module SubstratesHelper
  ...
  def substrate_feature(feature)
    length = col_feature('col-7 text-right mr-0 pr-2', "#{feature.length} нм;")
    litera = col_feature('col-5 ml-0 pl-0', "<strong class='mr-2'>#{feature.litera} #{fa_icon(feature.sign)}</strong>  #{feature.feature}")
