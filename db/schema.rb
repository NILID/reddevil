...
ActiveRecord::Schema.define(version: 2021_02_04_120827) do
  ...
  create_table "manufacture_groups", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.boolean "without_contract", default: false
  end
  ...
  create_table "manufactures", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.text "content"
    t.string "material_info", default: ""
  ...
  create_table "office_notes", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
